...
/*        // Great, now we can get all the stuff that we need for code execution
   ...
   /* public override InputLine getInputLine() {
        return new InputLine(command_field.text, new List<string> { direction_dropdown.value.ToString(), magnitude_field.text });
    }*/
    ...
    public override Command GetCommand() {
        return new MoveCommand(direction_dropdown.value.ToString(), Int32.Parse(magnitude_field.text));
    }
}
